...
class COCOPanoptic(BaseDataset):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(COCOPanoptic, self).__init__(root, dataset_type,split, is_train, crop_size, mirror, min_scale, max_scale,
        ...
        if 'test' in split:
            ...
            json_filename = os.path.join(self.root, 'annotations', 'panoptic_{}.json'.format(self.split))
            dataset = json.load(open(json_filename))
