...
from segmentation.evaluation.pastis_tool import Pastis_COCO
...
class COCOInstanceEvaluator:
    ...
    def update(self, instances, image_filename=None):
        ...
        for i in range(num_instances):
            ...
            image_id = int(os.path.basename(image_filename).split('_')[-1])
    ...
    def evaluate(self):
        ...
        if 'PASTIS' in self._gt_dir:
            coco_gt = Pastis_COCO(self._gt_dir)
        else:
