...
# -----------------------------------------------------------------------------
# Only for PASTIS Data
# -----------------------------------------------------------------------------
_C.DATASET.NORM = True
_C.DATASET.TARGET_TYPE = "instance"
_C.DATASET.MEM16 = None
_C.DATASET.FOLDS = None
_C.DATASET.CACHE = False
_C.DATASET.REFER_DATE = "2018-09-01" 
_C.DATASET.CLASS_MAPPING = None
_C.DATASET.MONODATE = None
# -----------------------------------------------------------------------------
# Solver
# -----------------------------------------------------------------------------
_C.SOLVER = CN()
